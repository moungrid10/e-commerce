...
String get orderStatusText => status == OrederStatus.delivred

? 'Delivered'
: status == OrederStatus.shipped
? 'Shipment on the way'
: 'Processing';
...
factory OrderModel.fromSnapshot(DocumentSnapshot snapshot){
  ...
  return OrderModel(
    ...
    status: OrederStatus.values.firstWhere((e) => e.toString() == data['status']), 
